...
class JTransformsFFT(signalSize: Int) : FFT {
    private val jfft = FloatFFT_1D(signalSize)
    private val spectrum = FloatArray(signalSize / 2)
    private val copy = FloatArray(signalSize)
    ...
    override fun spectrum(signal: FloatArray): FloatArray {
        ...
        for (i in spectrum.indices) {
            ...
            spectrum[i] = Math.sqrt(reali * reali + imagi * imagi)
        }
        return spectrum
    }
